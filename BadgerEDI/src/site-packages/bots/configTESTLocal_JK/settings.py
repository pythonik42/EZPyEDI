...
DJANGO_VER12 = (django.VERSION >= (1, 2))

#*******settings for bots error reports**********************************
MANAGERS = (    #bots will send error reports to the MANAGERS
    ('Badger EDI Administrator', 'jknaus@badgersportswear.com'),
    )
EMAIL_HOST = '195.1.2.225'  # Badger MS Exchange Server
EMAIL_PORT = '25'           # Default: 25
#EMAIL_HOST = 'localhost'
#EMAIL_PORT = '1025'          # local DebuggingProxy SMTP server
EMAIL_USE_TLS = False        # Default: False
EMAIL_HOST_USER = 'TracIT@badgersportswear.com'    #Default: ''. Username to use for the SMTP server defined in EMAIL_HOST. If empty, Django won't attempt authentication.
EMAIL_HOST_PASSWORD = 'badger@111'                 #Default: ''. PASSWORD to use for the SMTP server defined in EMAIL_HOST. If empty, Django won't attempt authentication.
SERVER_EMAIL = 'TracIT@badgersportswear.com'       #Sender of bots error reports. Default: 'root@localhost'
EMAIL_SUBJECT_PREFIX = '[Test EDI] '               #This is prepended on email subject.
...
DATABASE_NAME = '/EDITest/sqlitedb/botsdb'      #path to database; if relative path: interpreted relative to bots root directory
DATABASE_USER = ''
DATABASE_PASSWORD = ''
DATABASE_HOST = ''
DATABASE_PORT = ''
...
SECRET_KEY = 'mazziknaus5'

ADMINS = (
    ('bots', 'jknaus@badgersportswear.com'),
    )
