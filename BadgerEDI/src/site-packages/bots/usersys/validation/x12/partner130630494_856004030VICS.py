# vendor X12 856 4030 VICS validation rules for Dunham's Sports Inc. 130630494

from base_856004030VICS import fieldDescriptions, namedSegmentFormats
    ...
    return OutDocTreeMap(
        ...
        HL=ForLoop(
            ...
            TD3=SegList(
                _Y_USES='TRL',
                _TRL=Seg(
                    _Y_IF='@not X12.IsParcelCarrier.get(SHIP.Carrier.Code, None)',
                    TD301='TL',
                    ...
                    HL=ReRootAtOutSeg(
                        ...
                        HL=ReRootAtOutSeg(
                            ...
                            ForLoop(
                                ...
                                # not required by Dunham's, but accepted
                                PID=SegList(
...
contentRules = [         
    ...
    ('ST.HL*.TD5*',                        ROneOf('TD502', 'TD504', 'TD505', 'TD506', 'TD512')),
    ('ST.HL*.TD5?_SCAC',                   RCond('TD502', 'TD503')),
    ('ST.HL*.TD5?_SCAC',                   ROneOf('TD502', 'TD504', 'TD505', 'TD506', 'TD512')), 
    ('ST.HL*.TD5?_SCAC.TD502',             RMustBe('2')),
    ('ST.HL*.TD5?_SCAC.TD503',             RValueIn('UPSG','FEXI')),
    ...
    ('ST.HL*.N1*.N3',                      RReqs('N301')),
    ('ST.HL*.N1*.N4',                      RReqs('N401', 'N402', 'N403', 'N404')),
