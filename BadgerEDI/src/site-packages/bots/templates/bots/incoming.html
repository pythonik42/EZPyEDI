...
<form action="{{ form.action }}" method="post">
    ...
    <table id="botstable">
        ...
        <thead>
            <tr>
                <th></th>
                <th><button class="botsheader" type="submit" name="order" value="statust" />{% trans 'State' %}</button></th>
            ...
            <tr class="{% cycle 'row1' 'row2' %}">
                <td>
                    <div class="dropdown"><img class="action" src="/media/images/star.png" />
                        <ul>
                            <li><a href="/detail/?inidta={{row.idta}}" class="botslink">{% trans 'View detail' %}</a></li>
