...
EMAIL_SUBJECT_PREFIX = '[Badger EDI] '             #This is prepended on email subject.
...
DATABASE_NAME = '/EDI/sqlitedb/botsdb'      #path to database; if relative path: interpreted relative to bots root directory
DATABASE_USER = ''
DATABASE_PASSWORD = ''
DATABASE_HOST = ''
DATABASE_PORT = ''
